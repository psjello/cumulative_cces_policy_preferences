...
ces <- read_dta(paste0(wd, "Cumulative Policy/cumulative_ces_policy_preferences.dta"))
ces <- sjlabelled::as_label(ces)

# Crosswalks
wide_guide <- 
  read.csv(
    paste0(wd, "Cumulative Policy/output/latex-guide_preferences-crosswalk_wide-sanswording.csv"),
    stringsAsFactors=F)

wide <- 
  read.csv(
    paste0(wd, "Cumulative Policy/output/preferences-crosswalk_wide-withwording.csv"),
    stringsAsFactors=F)

long <- 
  read.csv(
    paste0(wd, "Cumulative Policy/output/preferences-crosswalk_long-withwording.csv"),
    stringsAsFactors=F)
