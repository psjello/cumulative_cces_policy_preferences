...
\bigskip
This guide provides details on each policy preference question item, including the years where the question item appears in the survey, frequency tables for item, and it's unique, year-specific variable name and question wording.  Some question items are more consistently asked than others.  Additionally, some question wording varies slightly across time, with more extreme changes warranting a note at the end of each question item's section.
